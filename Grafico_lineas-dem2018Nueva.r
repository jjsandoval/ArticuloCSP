...
#
ano3$Esc[ano3$Esc == 1] <- "0-3"
ano3$Esc[ano3$Esc == 2] <- "4-7"
ano3$Esc[ano3$Esc == 3] <- "8-11"
ano3$Esc[ano3$Esc == 4] <- "12+"
#
...
lano3.a2<-cbind("Edad"=ano3.a2$Edad, "Esc"=ano3.a2$Esc, lano3.a2)
################################# GRAFICOS HOMBRES  ###########################################
#setwd("~/Documentos/PhD_Demografia/TesisLatex/figure")
# grafico Alzheimer Año 2011 en Hombres
#pdf("alz10e2.pdf", paper= "a4r", width=14, height=8.5) # guardar plot PDF
grank<-range(lano3.a2$Hombre[1:4], lano3.a2$LIh[1:4], lano3.a2$LSh[1:4],
             lano3.a2$Hombre[5:8], lano3.a2$LIh[5:8], lano3.a2$LSh[5:8],
             lano3.a2$Hombre[9:12], lano3.a2$LIh[9:12], lano3.a2$LSh[9:12],
             lano3.a2$Hombre[13:16], lano3.a2$LIh[13:16], lano3.a2$LSh[13:16],
             lano3.a2$Hombre[17:20], lano3.a2$LIh[17:20], lano3.a2$LSh[17:20])

plot(lano3.a2$Hombre[1:4],type='o',axes=FALSE, ann=FALSE,ylim=grank,lwd=2)
axis(1,at=1:4,lab=ano3.a2$Esc[1:4])
axis(2, las=1,at=NULL)
box()
lines(lano3.a2$LSh[1:4], type="l", lty=3,lwd=2, col="gray50")
lines(lano3.a2$LIh[1:4], type="l", lty=3, lwd=2, col="gray50")
lines(lano3.a2$Hombre[5:8], type="o", pch=22, lty=2, lwd=2)
lines(lano3.a2$LSh[5:8], type="l", lty=3,lwd=2, col="gray50")
lines(lano3.a2$LIh[5:8], type="l", lty=3, lwd=2, col="gray50")
lines(lano3.a2$Hombre[9:12], type="o", pch=22, lty=4, lwd=2)
lines(lano3.a2$LSh[9:12], type="l", lty=3,lwd=2, col="gray50")
lines(lano3.a2$LIh[9:12], type="l", lty=3, lwd=2, col="gray50")
lines(lano3.a2$Hombre[13:16], type="o", pch=22, lty=5, lwd=2)
lines(lano3.a2$LSh[13:16], type="l", lty=3,lwd=2, col="gray50")
lines(lano3.a2$LIh[13:16], type="l", lty=3, lwd=2, col="gray50")
lines(lano3.a2$Hombre[17:20], type="o", pch=22, lty=5, lwd=2)
lines(lano3.a2$LSh[17:20], type="l", lty=3,lwd=2, col="gray50")
lines(lano3.a2$LIh[17:20], type="l", lty=3, lwd=2, col="gray50")
...
#
ano3a$Esc[ano3a$Esc == 1] <- "0-3"
ano3a$Esc[ano3a$Esc == 2] <- "4-7"
ano3a$Esc[ano3a$Esc == 3] <- "8-11"
ano3a$Esc[ano3a$Esc == 4] <- "12+"
#
...
lano3a.a2<-cbind("Esc"=ano3a$Esc,"Edad"=ano3a$Edad, lano3a.a2)
################################# GRAFICOS MUJERES #############################################
# grafico Alzheimer Año 2011
pdf("alz10d2.pdf", paper= "a4r", width=14, height=8.5) # guardar plot PDF
grank2<-range(lano3a.a2$Mujer[1:5], 
             lano3a.a2$Mujer[6:10], 
             lano3a.a2$Mujer[11:15], 
             lano3a.a2$Mujer[16:20])
             

plot(lano3a.a2$Mujer[1:5],type='o',axes=FALSE, ann=FALSE,lwd=2, ylim=grank2)
...
title(ylab="Logaritmo(x 100.000)", col.lab=rgb(0,0.1,0),font.main=1)
legend("bottomright", title="Nivel de Escolaridad", c(paste(c("0-3", "4-7","8-11","12+"))), 
...
grank3<-range(ano3a.a2$Mujer[1:5], ano3a.a2$LIm[1:5], ano3a.a2$LSm[1:5],
...
plot(ano3a.a2$Mujer[1:5],type='o',axes=FALSE, ann=FALSE,ylim=grank3,lwd=2)
axis(1,at=1:5,lab=ano3a.a2$Edad[1:5])
axis(2, las=1,at=NULL)
box()
...
legend("topleft", title="Nivel de Escolaridad", c(paste(c("0-3", "4-7","8-11","12+","ICR95%"))), 
